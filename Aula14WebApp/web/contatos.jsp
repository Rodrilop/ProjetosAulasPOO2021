...
<%@page import="br.edu.fatecpg.web.DatabaseContato"%>
...
<% 
    if(request.getParameter("contato.add") != null){
        ...
        DatabaseContato.addContato(newContato);
        response.sendRedirect(request.getRequestURI());
    }else if (request.getParameter("contato.remove") != null) {
        String email = request.getParameter("contato.email");
        DatabaseContato.removeContato(email);
        response.sendRedirect(request.getRequestURI());
    }
    
    ArrayList<Contato> contatos = DatabaseContato.getContatos(); 
%>
<html>
    <head>
